...
pub struct Content {
    ...
    #[prost(string, tag = "6")]
    pub images: ::prost::alloc::string::String,
...
pub mod metadata_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static("/crm_metadata.Metadata/Materialize");
            let mut req = request.into_streaming_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("crm_metadata.Metadata", "Materialize"));
...
pub mod metadata_server {
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/crm_metadata.Metadata/Materialize" => {
    ...
    pub const SERVICE_NAME: &str = "crm_metadata.Metadata";
